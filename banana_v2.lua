...
-- ==========================================
-- SEA FLAGS (kiểm tra PlaceId thực tế của Blox Fruits)
-- ==========================================
Sea1 = false
Sea2 = false
Sea3 = false
...
elseif v5 == 7449423635 then
    ...
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "❌ Sai Game!";
            Text = "Script chỉ hoạt động trong Blox Fruits! Đang kick...";
            Duration = 5;
        })
    end)
    task.wait(3)
    game:GetService("Players").LocalPlayer:Kick("Script chỉ hoạt động trong Blox Fruits! PlaceId không hợp lệ: " .. tostring(v5))
end
